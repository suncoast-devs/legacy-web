      ...
      <div className="app">
        <main>
          ...
          <section className="mission">
            <h2>We are a collective of software engineers, programmers, and designers in the Tampa Bay Area.</h2>
            <p>
              Our purpose is to promote a sense of community among local technology organizations and their members. We
              seek to better communication between leaders, centralize efforts, improve culture, and to support our
              members in a way that strengthens our community and promotes the common good.
            </p>
          </section>

          <section className="logo">
            <img src={images.logo} alt="Suncoast Developers Guild Logo" width="320" />
          </section>
          ...
          <section className="organizations">
            ...
            <ul>{orgs.sort((a, b) => a.created - b.created).map(org => <Meetup group={org} />)}</ul>
          </section>
        </main>
        <footer>
          <div className="join">
            <p>
              If you&rsquo;re a leader of a tech organization, and are interested in being a part of the Suncoast
              Developers Guild, contact
              <strong>
                {' '}
